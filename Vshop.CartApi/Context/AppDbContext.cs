...
namespace VShop.CartApi.Context
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().Property(c => c.CategoryName).HasMaxLength(100).IsRequired();

            modelBuilder.Entity<Product>().Property(c => c.Price).HasPrecision(12, 2);

            //CartHeader

            modelBuilder.Entity<CartHeader>().Property(c => c.UserId).HasMaxLength(255).IsRequired();
